<!DOCTYPE html>
<html lang="zxx">
<!-- Mirrored from specthemes.com/redbiz/redbiz-5/shop-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2019 12:52:15 GMT -->
...
<body>
    ...
    <header>
        <nav id="navigation4" class="container navigation">
            <div class="nav-header"> <a class="nav-brand" href="index.html"> <img src="img/logos/logo.png"
                        class="main-logo" alt="logo" id="main_logo"> </a>
                        ...
                        <div class="megamenu-panel">
                            <div class="megamenu-lists">
                                ...
                                <ul class="megamenu-list list-col-4">
                                    ...
                                    <li><a href="home-10.html">Home Page 10 <span class="menu-tag">NEW</span><span
                                                class="menu-tag">HOT</span></a></li>
    ...
    <div class="page-title-section" style="background-image: url(img/bg/pagetitle.jpg);">
        <div class="container">
            ...
            <ul>
                ...
                <li><a href="shopw-single.html">Shop Single</a></li>
            </ul>
        </div>
    </div>
                ...
                <div class="col-md-6 col-sm-6 col-12">
                    <div class="product-images">
                        <div class="main-img-slider">
                            <figure> <a href="#" data-size="1400x1400"> <img src="img/shop/single-1.jpg" alt="" /> </a>
                            </figure>
                            <figure> <a href="#" data-size="1400x1400"> <img src="img/shop/single-2.jpg"
                                        data-lazy="img/shop/single-2.jpg" alt="" /> </a> </figure>
                            <figure> <a href="#" data-size="1400x1400"> <img src="img/shop/single-3.jpg"
                                        data-lazy="img/shop/single-3.jpg" alt="" /> </a> </figure>
                            <figure> <a href="#" data-size="1400x1400"> <img src="img/shop/single-4.jpg"
                                        data-lazy="img/shop/single-4.jpg" alt="" /> </a> </figure>
                        </div>
                        <ul class="thumb-nav">
                            <li><img src="img/shop/single-1.jpg" alt="product-thumb" /></li>
                            <li><img src="img/shop/single-2.jpg" alt="product-thumb" /></li>
                            <li><img src="img/shop/single-3.jpg" alt="product-thumb" /></li>
                            <li><img src="img/shop/single-4.jpg" alt="product-thumb" /></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-12">
                    <div class="single-product">
                        ...
                        <div class="product-review-area"> <i class="fa fa-star" aria-hidden="true"></i> <i
                            ...
                            <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star-half-o"
                                aria-hidden="true"></i> <span>(1 customer review)</span> </div>
                        ...
                        <div class="quantity mt-30">
                            <form method="get"> <input type="number" name="quantity" min="1" max="9" step="1" value="1">
                                <button type="submit" class="dark-pulse-button add-to-cart-button">Buy Now</button>
                            </form>
                        </div>
                        ...
                        <div class="product-share mt-20"> <span>Share: </span> <a href="#"><i
                        ...
                        <div class='tabs tabs_animate mt-70'>
                            ...
                            <div id='tab-3' class="clearfix product-tab-body">
                                ...
                                <div class="customer-review">
                                    <div class="row">
                                        <div class="col-md-1 pr-0 hidden-sm-down"> <img src="img/blog/user2.png"
                                                alt="member">
                                            <div class="customer-review-stars"> <i class="fa fa-star"
                                ...
                                <form method="get" action="#" class="mt-60">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 col-12 mt-5">
                                            <div class="rating"> <label> <input type="radio" name="stars" value="1" />
                                                    <span class="icon">★</span> </label> <label> <input type="radio"
                                                        name="stars" value="2" /> <span class="icon">★</span> <span
                                                        class="icon">★</span> </label> <label> <input type="radio"
                                                        name="stars" value="3" /> <span class="icon">★</span> <span
                                                        class="icon">★</span> <span class="icon">★</span> </label>
                                                ...
                                                <label> <input type="radio" name="stars" value="5" /> <span
                                                        class="icon">★</span> <span class="icon">★</span> <span
                                                        class="icon">★</span> <span class="icon">★</span> <span
                                                        class="icon">★</span> </label> </div>
                                            <div class="row">
                                                <div class="review-input">
                                                    <div class="col-md-6"> <input type="text" name="name"
                                                            placeholder="Your Name"> </div>
                                                    <div class="col-md-6"> <input type="email" name="email"
                                                            placeholder="Your Email"> </div>
                                                    <div class="col-md-12"> <textarea name="review"
                                                            placeholder="Your Review"></textarea>
                                                        <div class="right-holder"> <button type="submit">Send</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<!-- Mirrored from specthemes.com/redbiz/redbiz-5/shop-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2019 12:52:48 GMT -->
