    ...
    <div class="section-block">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-12"> <img src="img/content/home5.jpg"
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="feature-flex-square-content">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus bibendum,
                                            nunc ut.</p><a href="#" class="feature-flex-square-content-button">Learn
                                            More</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row mt-50">
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="team-member">
                        ...
                        <div class="team-member-text">
                            <h4><a href="#">Jack Semper</a></h4> <span>Majority Owner</span>
                ...
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="team-member">
                        ...
                        <div class="team-member-text">
                            <h4><a href="#">Ann Smith</a></h4> <span>Finance Lead</span>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                incididunt ut labore et dolore magna aliqua.</p>
                            <ul>
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="team-member">
                        ...
                        <div class="team-member-text">
                            <h4><a href="#">Philip Wilson</a></h4> <span>Networking Lead</span>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                incididunt ut labore et dolore magna aliqua.</p>
                            <ul>
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
